...
Also, the tipping point is for density, therefore, I have set the probability of spread to be constant (100% in my case) 

* The tipping point in original case came out to be around 58-61.
* The tipping point after modification case came out to be around 38-41. This has decreased drastically compared to previous value.

The above results makes sense, as the tipping point reduced significantly after the modification of Q2. It is because now each agent has 8 neighbours unlike in the original model where there were 4 neighbours. Since the neighbours have increase, it is easier for the fire to spread across the forest. And hence we see that we need to decrease the density by approximate 20 % to find the tipping point for live vs burnt forest. 
@#$#@#$#@
default
true
0
